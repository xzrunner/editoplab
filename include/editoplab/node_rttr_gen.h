...
#define PARM_FILEPATH editopgraph/component/##PARM_NODE_CLASS##.parm.h
#endif

#define RTTR_NAME editoplab::##PARM_NODE_NAME

rttr::registration::class_<editoplab::node::PARM_NODE_CLASS>(XSTR(RTTR_NAME))
.constructor<>()

#define PARAM_INFO(id, type, name, member, default_val)        \
.property(#name, &editoplab::node::##PARM_NODE_CLASS::member)        \
(                                                              \
